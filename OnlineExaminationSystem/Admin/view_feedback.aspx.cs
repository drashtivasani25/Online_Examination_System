...
namespace OnlineExaminationSystem.Admin
{
    public partial class view_feedback : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("DELETE FROM [feedback] WHERE [FeedbackId] = @FeedbackId", con);
            cmd.Parameters.AddWithValue("FeedbackId", btn.CommandArgument);
            ...
            {
                Response.Write("<script>alert('Feedback not deleted. Please try again.');</script>");
